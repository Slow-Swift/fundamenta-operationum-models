...
export class Proposition20 extends Model {
  ...
  createModel() {
    ...
    const g = this.geometry = {
      ...
      ecliptic: new Equator(Point(90, () => 90 - c.LEM)),
      HL: new Arc(p.H, p.L),
      HM: new Arc(p.H, p.M),
      HE: new Arc(p.H, p.E),
  ...
  setupGui(gui) {
    gui.addSlider('Distance to Ascension', this.parameters, 'ascensionDistance', -90, 90);
    this.altitudeSlider = gui.addSlider('Altitude', this.parameters, 'altitude', 0, 90);
  }
